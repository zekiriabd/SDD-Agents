...
```json
{
  ...
  "properties": {
    ...
    "placed_at_max": {
      "description": "Borne haute incluse sur `placed_at`.",
      "format": "date-time",
      "type": "string"
    },
    "placed_at_min": {
      "description": "Borne basse incluse sur `placed_at`.",
      "format": "date-time",
      "type": "string"
    },
    "shipping_method": {
      "description": "Filtre optionnel sur `shipping_method` — égalité stricte, jamais une expression. Valeurs admises : express, standard.",
      "enum": [
        "express",
        "standard"
      ],
    ...
    "status": {
      "description": "Filtre optionnel sur `status` — égalité stricte, jamais une expression. Valeurs admises : created, paid, preparing, shipped, delivered, cancelled, returned.",
      "enum": [
        "created",
        "paid",
        "preparing",
...
Fichier : `workspace/proof/suites/tool-1-orders-search.yaml`
