# TOOL CONTRACT: 1-customers-lookup
...
```json
{
  ...
  "properties": {
    "customer_id": {
      "description": "Clé d'identification de l'enregistrement recherché (`customer_id`).",
      "type": "string"
    }
  },
  "required": [
...
Fichier : `workspace/proof/suites/tool-1-customers-lookup.yaml`
