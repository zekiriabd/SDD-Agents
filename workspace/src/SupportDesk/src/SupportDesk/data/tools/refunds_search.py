...
# Schéma figé : workspace/src/SupportDesk/src/SupportDesk/data/schemas/refunds.schema.json
...
SPEC = ToolSpec.from_contract("1-refunds-search")
...
async def refunds_search(params: Input, *, ctx: ToolContext) -> Output:
    """Recherche filtrée. Remboursements déjà DEMANDÉS ou ÉMIS, un par remboursement. Utiliser pour :"""
