...
SPEC = ToolSpec.from_contract("1-payments-search")
...
async def payments_search(params: Input, *, ctx: ToolContext) -> Output:
    """Recherche filtrée. Paiements, un par tentative de règlement d'une commande. Utiliser pour : dire"""
