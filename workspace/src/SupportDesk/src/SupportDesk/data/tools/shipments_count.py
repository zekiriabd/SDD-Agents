...
SPEC = ToolSpec.from_contract("1-shipments-count")
...
async def shipments_count(params: Input, *, ctx: ToolContext) -> Output:
    """Comptage filtré. Suivi transporteur, un enregistrement par commande EXPÉDIÉE (clé = order_id)."""
