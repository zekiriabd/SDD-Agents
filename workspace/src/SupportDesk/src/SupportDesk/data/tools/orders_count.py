...
# Schéma figé : workspace/src/SupportDesk/src/SupportDesk/data/schemas/orders.schema.json
...
SPEC = ToolSpec.from_contract("1-orders-count")
...
async def orders_count(params: Input, *, ctx: ToolContext) -> Output:
    """Comptage filtré. Commandes client, un enregistrement par commande. Utiliser pour : vérifier qu'une"""
