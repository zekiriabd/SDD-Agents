...
SPEC = ToolSpec.from_contract("1-invoices-count")
...
async def invoices_count(params: Input, *, ctx: ToolContext) -> Output:
    """Comptage filtré. Factures, une par commande confirmée (une commande `created` dont le paiement a"""
