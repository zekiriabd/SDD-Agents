...
# Schéma figé : workspace/src/SupportDesk/data/schemas/claims.schema.json
...
SPEC = ToolSpec.from_contract("1-claims-count")
...
async def claims_count(params: Input, *, ctx: ToolContext) -> Output:
    """Comptage filtré. Réclamations existantes, une par réclamation. À consulter AVANT de proposer"""
