...
SPEC = ToolSpec.from_contract("1-customers-count")
...
async def customers_count(params: Input, *, ctx: ToolContext) -> Output:
    """Comptage filtré. Fiche client, un enregistrement par client. Utiliser pour : s'adresser au"""
