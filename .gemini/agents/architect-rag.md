...
tools: ["read_file", "write_file", "glob", "list_directory", "grep_search", "run_shell_command"]
...
- Outils autorisés : `read_file`, `write_file`, `glob`, `list_directory`, `grep_search`, `run_shell_command`
