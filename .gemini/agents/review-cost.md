...
tools: ["read_file", "glob", "list_directory", "grep_search", "run_shell_command", "write_file"]
model: gemini-3-flash-preview
---
<!-- GÉNÉRÉ par sdda_admin/harness_build.py depuis .sdda/agents/review-cost.md.
     NE PAS ÉDITER ICI : toute modification est écrasée au build suivant,
     et le test de parité la signale. Éditer la source. -->

# Agent `review-cost`

- Tier : `fast` (plancher `fast`, plafond `balanced`)
- Outils autorisés : `read_file`, `glob`, `list_directory`, `grep_search`, `run_shell_command`, `write_file`
