...
| **Contrat par outil** | `workspace/contracts/tools/{n}-{server}-{tool}.tool.md` — **un par outil allowlisté**, avant tout câblage (TOOL GATE) |
...
`workspace/datasets/adversarial/{agent}.jsonl` avec des cas **« le serveur MCP
