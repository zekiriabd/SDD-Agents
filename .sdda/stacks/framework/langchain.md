...
SPEC = ToolSpec.from_contract("1-invoice-lookup")   # lit workspace/pipeline/contracts/tools/1-invoice-lookup.tool.md → name, description, side_effect_class, trust, timeout_s, errors
