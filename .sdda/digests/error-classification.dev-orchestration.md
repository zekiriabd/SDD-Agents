<!-- GÉNÉRÉ par sdda_admin/sync_digests.py — ne pas éditer à la main.
     Source : la fiche .sdda/agents/dev-orchestration.md + rules/error-classification.md
     Régénérer : python .sdda/sdda.py sync-digests -->

# Digest — classes d'erreur de `dev-orchestration`
...
- `[ORCH_DIVERGES_FROM_IR]`
- `[ORCH_MANIFEST_MISSING]`
- `[OWNERSHIP_FROZEN_ZONE_CHANGED]`
- `[OWNERSHIP_VIOLATION]`
- `[PROJECT_NOT_INIT]`
- `[SHARED_TYPE_MISSING]`
- `[TOPOLOGY_EDGE_MISSING]`
- `[UNBOUNDED_LOOP]`
