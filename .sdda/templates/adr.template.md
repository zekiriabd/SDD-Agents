...
|---|---|---|---|
| <ex. coût mesuré par run> | <≤ 0.05 USD> | `workspace/pipeline/datasets/holdout/…` | <date> |
| <ex. recall@8> | <≥ 0.80> | `workspace/pipeline/datasets/golden/retrieval-…` | <date> |
...
- MISSION / CAPs : `workspace/pipeline/missions/{n}-…md`, `workspace/pipeline/caps/{n}-{m}-…md`
- TOPOLOGY : `workspace/pipeline/topology/{n}-topology.md` §9
- Contrats touchés : <…>
