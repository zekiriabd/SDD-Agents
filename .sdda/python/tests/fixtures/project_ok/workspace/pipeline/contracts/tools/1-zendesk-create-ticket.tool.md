...
| Aspect | Valeur |
|---|---|
| Idempotence | `natural-key:conversation_id` |
| Dry-run supporté | oui |
| Confirmation | `never` |
| Plafond par run | 1 ticket max |
| Allowlist | priorité normale uniquement |
| Journalisation | tout appel tracé avec args redigés |
...
Fichier : `workspace/pipeline/suites/tool-1-zendesk-create-ticket.yaml`
