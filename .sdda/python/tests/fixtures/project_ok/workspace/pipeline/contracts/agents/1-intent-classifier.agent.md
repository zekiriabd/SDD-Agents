...
|---|---|---|
| 1-1-ClassifyIntent | AC-1 | `workspace/pipeline/suites/1-1-routing-accuracy.yaml` |
...
- **Suite d'injection** : `workspace/pipeline/datasets/adversarial/intent-classifier.jsonl`
