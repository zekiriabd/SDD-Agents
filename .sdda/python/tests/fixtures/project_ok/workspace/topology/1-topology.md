...
Fichier : `workspace/topology/1-topology.mmd` (Mermaid).
...
| Type | Fichier |
|---|---|
| agent | `workspace/contracts/agents/1-intent-classifier.agent.md` |
| agent | `workspace/contracts/agents/1-billing-specialist.agent.md` |
| tool | `workspace/contracts/tools/1-invoice-lookup.tool.md` |
| tool | `workspace/contracts/tools/1-zendesk-create-ticket.tool.md` |
| retrieval | `workspace/contracts/retrieval/1-contracts-index.retrieval.md` |
