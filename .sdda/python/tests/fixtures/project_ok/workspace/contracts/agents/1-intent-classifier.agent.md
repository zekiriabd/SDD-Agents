...
|---|---|---|
| 1-1-ClassifyIntent | AC-1 | `workspace/evals/suites/1-1-routing-accuracy.yaml` |

## 3. Prompt

- Fichier : `workspace/prompts/intent-classifier.system.md`
- Hash : `sha256:…`
- Rédigé par : `dev-prompt` depuis ce contrat

## 4. Outils

Aucun outil : la classification est un jugement pur.
...
- **Suite d'injection** : `workspace/datasets/adversarial/intent-classifier.jsonl`
