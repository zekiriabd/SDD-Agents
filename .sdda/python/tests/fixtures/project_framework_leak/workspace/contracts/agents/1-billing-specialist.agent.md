...
Nœud du StateGraph LangGraph qui explique une ligne de facture en s'appuyant sur
les documents contractuels récupérés. Ne rembourse jamais : il ouvre un ticket.

## 2. Capabilities servies

| CAP | AC couverts | Évaluée par |
|---|---|---|
| 1-2-ExplainInvoiceLine | AC-1, AC-2 | `workspace/evals/suites/1-2-groundedness.yaml` |

## 3. Prompt

- Fichier : `workspace/prompts/billing-specialist.system.md`
- Hash : `sha256:…`
...
- **Suite d'injection** : `workspace/datasets/adversarial/billing-specialist.jsonl`
