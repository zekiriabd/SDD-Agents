...
|---|---|---|
| 1-2-ExplainInvoiceLine | AC-1, AC-2 | `workspace/pipeline/suites/1-2-groundedness.yaml` |
...
- **Suite d'injection** : `workspace/pipeline/datasets/adversarial/billing-specialist.jsonl`
