...
| Type | Fichier |
|---|---|
| agent | `workspace/feats/contracts/agents/1-intent-classifier.agent.md` |
| agent | `workspace/feats/contracts/agents/1-billing-specialist.agent.md` |
| tool | `workspace/feats/contracts/tools/1-invoice-lookup.tool.md` |
| tool | `workspace/feats/contracts/tools/1-zendesk-create-ticket.tool.md` |
| retrieval | `workspace/feats/contracts/retrieval/1-contracts-index.retrieval.md` |
