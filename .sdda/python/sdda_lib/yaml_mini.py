...
#: Clé nue, ou clé ENTRE GUILLEMETS (échappements `\"` et `''` compris) — la
#: seule façon d'écrire une clé qui contient `:`. Les tags Ollama (`qwen3:32b`)
#: sont des identifiants de modèle, et `providers/local-ollama.yaml` les porte en
#: clé de sa table de tarifs : sans cette forme, le fichier était illisible et ses
#: tarifs n'existaient pour aucun script.
